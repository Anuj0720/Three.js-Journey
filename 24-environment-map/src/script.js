...
// HDR (RGBE) Equilateral
// rgbeLoader.load('/environmentMaps/blender-2k-studio.hdr', (environmentMap) =>{
...
// 1.add environment map, 2.add torus, 3.animate the torus, 4.Cube render target
